...
# print mpd files for 5 step equilibration
...
;
refcoord_scaling        = com" > "${output}/${project}_${i}K/equil1.mdp"
printf "integrator              = md
dt                      = 0.002
nsteps                  = 500000
nstlog                  = 5000
...
comm_grps               = MEMB   SOL_ION
;
refcoord_scaling        = com" > "${output}/${project}_${i}K/equil2.mdp"
printf "integrator              = md
dt                      = 0.002
nsteps                  = 500000
nstlog                  = 5000
...
comm_grps               = MEMB   SOL_ION
;
refcoord_scaling        = com" > "${output}/${project}_${i}K/equil3.mdp"
printf "integrator              = md
dt                      = 0.002
nsteps                  = 500000
nstlog                  = 5000
...
comm_grps               = MEMB   SOL_ION
;
refcoord_scaling        = com" > "${output}/${project}_${i}K/equil4.mdp"
printf "integrator              = md
dt                      = 0.002
nsteps                  = 500000
nstlog                  = 5000
...
gmx grompp -f equil1.mdp -o equil_${i}K_1.tpr -c 121ns_equil.gro -t 121ns_equil.cpt -n System.ndx -p System.top -maxwarn -1
