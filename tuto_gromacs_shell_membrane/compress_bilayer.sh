...
# this is array with the pressure, which will be applied on Z for each of the replicas
mega_array=('15.0' '25.0' '35.0' '45.0' '55.0'); # pressure in bars
...
gmx grompp -f equil0.mdp -o equil_${i}bar_0.tpr -c 121ns_equil.gro -t 121ns_equil.cpt -n System.ndx -p System.top -maxwarn -1
